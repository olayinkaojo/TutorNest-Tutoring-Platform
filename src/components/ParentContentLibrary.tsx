...
export function ParentContentLibrary({ session, parentId, subscriptionTier = 'basic' }: ParentContentLibraryProps) {
  ...
  const GRADE_LEVELS = [
    ...
    { value: 'nursery_1', label: 'Nursery 1 (Pre-Primary)' },
    { value: 'nursery_2', label: 'Nursery 2 (Pre-Primary)' },
    { value: 'nursery_3', label: 'Nursery 3 / Reception' },
    { value: 'primary_1', label: 'Primary 1 (P1) – Year 1' },
    { value: 'primary_2', label: 'Primary 2 (P2) – Year 2' },
    { value: 'primary_3', label: 'Primary 3 (P3) – Year 3' },
    { value: 'primary_4', label: 'Primary 4 (P4) – Year 4' },
    { value: 'primary_5', label: 'Primary 5 (P5) – Year 5' },
    { value: 'primary_6', label: 'Primary 6 (P6) – Year 6' },
    { value: 'secondary_7', label: 'JSS 1 (Junior Secondary 1) – Year 7' },
    { value: 'secondary_8', label: 'JSS 2 – Year 8' },
    { value: 'secondary_9', label: 'JSS 3 – Year 9' },
    { value: 'secondary_10', label: 'SS 1 (Senior Secondary 1) – Year 10' },
    { value: 'secondary_11', label: 'SS 2 – Year 11' },
    { value: 'sixth_form_12', label: 'SS 3 – Year 12 / College' },
    { value: 'sixth_form_13', label: 'Post-Secondary' },
  ];
